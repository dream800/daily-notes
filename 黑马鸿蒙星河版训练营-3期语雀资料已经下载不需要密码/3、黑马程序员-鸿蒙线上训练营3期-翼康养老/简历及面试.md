> 大专好像也可以 但是需要2-3年的开发经验-赶工期
> 全国出差-外包有补贴

> 有工作经验的基本不用听 2年及以上

> 10个问题-6个以上能答上
> 1. 什么时候学的鸿蒙为什么学鸿蒙之前干什么-大环境不好，工作不好找，赛道太拥挤
> 2. 鸿蒙和安卓和ios有什么区别？借鉴了ts compose swiftUI flutter React Vue
> 3. 你觉得鸿蒙里面哪些东西最难啊？ 有没有印象比较深刻的点！！！ 环境最难！！！文档查东西，设备调试。模拟器，录音-pcm 生态不完善- 微信
> 4. 组件通信 状态修饰符 生命周期 ability生命周期。ability传值- 基础问题
> 5. 性能优化 三层架构 多线程
> 6. 性能优化- 客观原因-我们原来都在赶进度，根本没时间，华为的人一周一次，来一次催一次进度，
> 7. 性能优化-三层架构-hap-多hsp- 模块拆分，资源分散- 懒加载-延迟加载-虚拟列表（LazyForEach）-多线程请求-组件封装-浅层级UI布局，循环Key灵活使用
> 
动态import- 使用这个包或者能力时在引用
> import("a.ets").then(res => {. })
> 
> 不阻塞主线程- 多线程不能用闭包-还有线程安全的问题-锁的概念。鸿蒙没有锁- 线程安全自己控制
> 
> taskPool和worker 的区别
> 
> 架构设计- 没有架构设计- 三层架构
...
>   utils
> 
> product 就应该是个空壳子 入口页面
> features  按照模块划分
> basic.  能力集 组件库 方法库 底层封装库 
> 
> 
